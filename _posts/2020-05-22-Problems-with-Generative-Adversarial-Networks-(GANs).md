...
1. *Mode dropping*[^5] (AKA *mode collapse*): In practice GANs might generate only a limited subset of the desired outputs verity, and ignore modes of the underlying true data distribution.
