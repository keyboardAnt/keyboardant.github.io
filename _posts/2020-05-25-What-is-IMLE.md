...
### GANs learning approach: minimizing the objective will minimize an $f$-divergence

#### Theoretical guarantees

GANs are based on the idea of minimizing the distinguishability between data and samples. It has been shown that when given access to an infinitely powerful discriminator, the GAN objective *minimizes* a few instances of [$f$-divergences](https://en.wikipedia.org/wiki/F-divergence).[^2]
